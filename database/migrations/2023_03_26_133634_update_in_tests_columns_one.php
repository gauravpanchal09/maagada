...
class UpdateInTestsColumnsOne extends Migration
{
    ...
    public function up()
    {
        Schema::table('in_tests', function (Blueprint $table) {
            ...
            $table->text('wife_ici_day_7')->nullable();
            $table->date('wife_ici_date_7')->nullable();
            $table->text('wife_ici_endo_7')->nullable();
            $table->text('wife_ici_rtov_7')->nullable();
            $table->text('wife_ici_ltov_7')->nullable();
            $table->text('wife_ici_remark_7')->nullable();
            $table->text('wife_ici_day_8')->nullable();
            $table->date('wife_ici_date_8')->nullable();
            $table->text('wife_ici_endo_8')->nullable();
            $table->text('wife_ici_rtov_8')->nullable();
            $table->text('wife_ici_ltov_8')->nullable();
            $table->text('wife_ici_remark_8')->nullable();
            $table->text('wife_ici_day_9')->nullable();
            $table->date('wife_ici_date_9')->nullable();
            $table->text('wife_ici_endo_9')->nullable();
            $table->text('wife_ici_rtov_9')->nullable();
            $table->text('wife_ici_ltov_9')->nullable();
            $table->text('wife_ici_remark_9')->nullable();
            $table->text('wife_ici_day_10')->nullable();
            $table->date('wife_ici_date_10')->nullable();
            $table->text('wife_ici_endo_10')->nullable();
            $table->text('wife_ici_rtov_10')->nullable();
            $table->text('wife_ici_ltov_10')->nullable();
            $table->text('wife_ici_remark_10')->nullable();
            $table->json('wife_ici_extra_data')->nullable();
    ...
    public function down()
    {
        Schema::table('in_tests', function (Blueprint $table) {
            ...
            $table->dropColumn('wife_ici_day_7');
            $table->dropColumn('wife_ici_date_7');
            $table->dropColumn('wife_ici_endo_7');
            $table->dropColumn('wife_ici_rtov_7');
            $table->dropColumn('wife_ici_ltov_7');
            $table->dropColumn('wife_ici_remark_7');
            $table->dropColumn('wife_ici_day_8');
            $table->dropColumn('wife_ici_date_8');
            $table->dropColumn('wife_ici_endo_8');
            $table->dropColumn('wife_ici_rtov_8');
            $table->dropColumn('wife_ici_ltov_8');
            $table->dropColumn('wife_ici_remark_8');
            $table->dropColumn('wife_ici_day_9');
            $table->dropColumn('wife_ici_date_9');
            $table->dropColumn('wife_ici_endo_9');
            $table->dropColumn('wife_ici_rtov_9');
            $table->dropColumn('wife_ici_ltov_9');
            $table->dropColumn('wife_ici_remark_9');
            $table->dropColumn('wife_ici_day_10');
            $table->dropColumn('wife_ici_date_10');
            $table->dropColumn('wife_ici_endo_10');
            $table->dropColumn('wife_ici_rtov_10');
            $table->dropColumn('wife_ici_ltov_10');
            $table->dropColumn('wife_ici_remark_10');
            $table->dropColumn('wife_ici_extra_data');
